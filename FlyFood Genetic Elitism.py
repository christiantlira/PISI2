...
def nova_populacao(rotas_selecionadas, taxa_elitismo):
    ...
    for i in range(taxa_elitismo):
        filhos_lista.append(rotas_selecionadas[i])

    #Completa a próxima geração com os filhos gerados pelos pais selecionados.
    for i in range(len(rotas_selecionadas) - taxa_elitismo):
...
def geracao_seguinte(geracao_atual, taxa_elitismo, taxa_mutacao):
    ...
    filhos = nova_populacao(rotas_selecionadas, taxa_elitismo)
...
def principal(populacao, tamanha_populacao, taxa_elitismo, taxa_mutacao, geracoes):
    ...
    for i in range(geracoes):
        ...
        populacao_atual = geracao_seguinte(populacao_atual, taxa_elitismo, taxa_mutacao)
...
resposta = principal(pontos_de_entrega, 400, 150, 0.01, 80)
#print(resposta)
